      ...
      headers: {
        ...
        "Content-Security-Policy":
          mode === "development"
            ...
            : "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.mxpnl.com https://www.googletagmanager.com https://us.i.posthog.com https://assets.apollo.io https://embed.typeform.com https://js.intercomcdn.com https://widget.intercom.io https://*.intercom.io; connect-src 'self' https://*.supabase.co https://cdn.mxpnl.com https://*.mixpanel.com https://*.posthog.com https://*.intercom.io https://*.apollo.io https://*.typeform.com wss://*.intercom.io https://api-iam.intercom.io https://www.google-analytics.com https://*.google-analytics.com; img-src 'self' data: https: blob: https://*.intercomassets.com https://static.intercomassets.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; frame-src 'self' https://*.intercom.io https://*.typeform.com;",
      },
    },
    plugins: [react()],
    resolve: {
