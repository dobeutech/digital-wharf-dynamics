        ...
        <div className="space-y-12 md:space-y-16">
          <section aria-labelledby="story-heading">
            ...
            <p className="text-base sm:text-lg text-muted-foreground mb-4">
              We started DOBEU with one goal: help businesses use modern technology to grow.
              Every company should have access to great digital tools, no matter their size.
            </p>
            <p className="text-base sm:text-lg text-muted-foreground mb-4">
              Our team brings years of experience in web development and software engineering.
              We create solutions that work today and prepare you for tomorrow.
            </p>
            <p className="text-base sm:text-lg text-muted-foreground">
              We focus on building tools that solve real problems. No unnecessary complexity.
              Just results that help your business succeed.
            </p>
          </section>
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Jeremy is a full-stack developer who builds digital solutions for growing businesses.
                      He specializes in modern web technologies and helps companies scale with the right tools.
                    </p>
