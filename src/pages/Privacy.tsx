          ...
          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Send targeted marketing communications and promotional offers
                ...
                <li>
                  Monitor and analyze trends, usage patterns, and user behavior
                </li>
                <li>
                  Train and improve our algorithms and machine learning models
                </li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">
                3. Marketing Communications Opt-In
              </h2>
              <p className="mb-4">
                <strong>Email Marketing:</strong> When you subscribe to our
                newsletter or check the marketing consent checkbox during
                registration, you expressly opt-in to receive:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>Promotional emails and special offers</li>
                <li>Newsletter updates ("The Digital Wharf")</li>
                <li>
                  Targeted marketing based on your preferences and behavior
                </li>
                <li>Partner offers and third-party promotions</li>
              </ul>
              <p className="mb-4">
                <strong>SMS/Text Marketing:</strong> By providing your phone
                number and checking the SMS opt-in checkbox, you expressly
                consent to receive text messages including promotional content,
                reminders, and marketing offers. Standard message and data rates
                apply. Reply STOP to opt-out.
              </p>
              <p>
                You can withdraw consent at any time via unsubscribe links,
                account settings, or by contacting privacy@dobeu.cloud.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-foreground mb-4">
                4. Data Sales & Third-Party Sharing
              </h2>
              <p className="mb-4">
                <strong>We May Sell Your Data:</strong> Dobeu Tech Solutions
                reserves the right to sell, license, rent, or share your
                personal information with third parties for monetary or other
                valuable consideration. This includes:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-4">
                <li>
                  Advertising networks and platforms for targeted advertising
                </li>
                ...
                <li>
                  Any third party for marketing, advertising, or commercial
                  purposes
                </li>
              </ul>
              <p className="mb-4">
                Data shared may include both anonymized/aggregated data and
                personally identifiable information, depending on the
                arrangement with the third party.
              </p>
              <p className="mb-4">
                <strong>Service Providers:</strong> We also share your
                information with:
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Analytics:</strong> PostHog and Google Analytics for
                  user behavior analysis
                </li>
                <li>
                  <strong>Marketing:</strong> Google Ads and advertising
                  partners for targeted campaigns
                </li>
                <li>
                  <strong>Customer Support:</strong> Intercom for communication
                  and support
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                behavior, preferences, and device. This data is used for
                analytics, personalization, and targeted advertising. You can
            ...
            <section>
              ...
              <p className="mb-4">
                <strong>To Opt-Out of Data Sales:</strong> Submit a request to
                privacy@dobeu.cloud with the subject line "Do Not Sell My
                Personal Information" or contact us using the information below.
              </p>
              <p>
                We will respond to verified consumer requests within 45 days as
                required by law.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                retention period is required by law. Project files are retained
            ...
            <section>
              ...
              <p>
                ...
                infrastructure. However, no method of transmission over the
            ...
            <section>
              ...
              <p>
                ...
                information, we will delete such information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                material changes by posting the new policy on this page with an
            ...
            <section>
              ...
              <p>
                ...
                <br />
                <br />
                For data sale opt-out requests, email: privacy@dobeu.cloud with
