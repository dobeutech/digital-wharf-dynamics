...
import { ExternalLink, BarChart3, Users, MousePointer, TrendingUp, Activity, Eye, ArrowRight } from "lucide-react";
...
export default function AdminAnalytics() {
  ...
  const posthogProjectUrl = "https://us.posthog.com/project/phc_Gaksl1OP0ZVYeErlumeRTuj5xJqPMQPe3H8UKxMpwAM";
  ...
  const funnelSteps = [
    ...
    { step: 4, name: "Service Detail Viewed", event: FUNNEL_STEPS.SERVICE_DETAIL_VIEWED },
    { step: 5, name: "Checkout Initiated", event: FUNNEL_STEPS.CHECKOUT_INITIATED },
    { step: 6, name: "Purchase Complete", event: FUNNEL_STEPS.PURCHASE_COMPLETE },
  ];
          ...
          <Card className="shadow-material border-l-4 border-l-purple-500">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="text-xs text-muted-foreground">
                Use <code className="bg-muted px-1 py-0.5 rounded">isFeatureEnabled('flag_key')</code> in code
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
              ...
              {funnelSteps.map((step, index) => (
                <div key={step.event} className="flex items-center">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs text-center mt-2 max-w-20">{step.name}</span>
                  </div>
            ...
            <div className="mt-4 p-4 bg-muted rounded-lg">
              <p className="text-sm text-muted-foreground">
                <strong>Events tracked:</strong> Each step fires both Mixpanel and PostHog events for cross-platform funnel analysis.
              </p>
            </div>
          </CardContent>
        </Card>
