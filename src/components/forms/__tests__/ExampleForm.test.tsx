...
describe('ExampleForm', () => {
  ...
  describe('Validation', () => {
    ...
    it('shows error when terms are not agreed', async () => {
      ...
      const generalOption = await screen.findByRole('option', { name: /general inquiry/i });
  ...
  describe('Accessibility', () => {
    ...
    it('associates error messages with fields', async () => {
      ...
      await waitFor(() => {
        ...
        expect(nameInput).toHaveAttribute('aria-describedby', expect.stringContaining('message'));
      });
    });
  });
